...
P.CAPS[P.WYVERN_LORD_F] 	= {60, 25, 26, 24, 27, 23, 30} -- 78
							-- 6:  25, 26, 23, 29, 23
P.CAPS[P.WYVERN_LORD_M]		= {60, 27, 25, 23, 28, 22, 30} -- 78
							-- 6:  26, 26, 23, 30, 22
...
P.CAPS[P.BISHOP_M]			= {60, 25, 26, 24, 22, 30, 30}
							-- 6:  25, 26, 25, 22, 30
P.CAPS[P.SAGE_F]			= {60, 30, 28, 26, 21, 25, 30} -- 78
							-- 6:  30, 28, 25, 20, 25	
P.CAPS[P.SAGE_M]			= {60, 28, 30, 26, 21, 25, 30} -- 78
							-- 6:  28, 30, 25, 20, 25
...
P.CAPS[P.GENERAL_F]			= {60, 27, 28, 25, 29, 26, 30} -- 8 none in 7, but different stats?
							-- 6:  25, 25, 22, 30, 26
P.CAPS[P.GENERAL_M]			= {60, 29, 27, 24, 30, 25, 30} -- 78
							-- 6:  27, 25, 21, 30, 25
P.CAPS[P.PALADIN_F]			= {60, 23, 27, 25, 24, 26, 30} -- 78 none in 6, but different stats?
P.CAPS[P.PALADIN_M]			= {60, 25, 26, 24, 25, 25, 30} -- 78
							-- 6:  25, 28, 25, 25, 25
P.CAPS[P.GREAT_KNIGHT_F]	= {60, 26, 26, 25, 28, 26, 30} --__8
P.CAPS[P.GREAT_KNIGHT_M]	= {60, 28, 24, 24, 29, 25, 30} --__8
P.CAPS[P.S_RECRUIT]			= {60, 23, 30, 29, 22, 26, 30} --__8

P.CAPS[P.WARRIOR]			= {60, 30, 28, 26, 26, 22, 30}
							-- 6:  30, 26, 24, 28, 20
P.CAPS[P.BERSERKER]			= {60, 30, 29, 28, 23, 21, 30}
							-- 6:  30, 24, 28, 22, 24
P.CAPS[P.HERO_F]			= {60, 24, 30, 26, 24, 24, 30} --678
P.CAPS[P.HERO_M]			= {60, 25, 30, 26, 25, 22, 30} --678
P.CAPS[P.TROOPER_F]			= {60, 23, 28, 30, 22, 25, 30} --678
P.CAPS[P.TROOPER_M]			= {60, 25, 28, 30, 24, 23, 30} -- 78
							-- 6:  23, 28, 30, 24, 23
P.CAPS[P.SNIPER_F]			= {60, 24, 30, 29, 24, 24, 30} -- 78
							-- 6:  23, 30, 29, 24, 24
P.CAPS[P.SNIPER_M]			= {60, 25, 30, 28, 25, 23, 30} -- 78
							-- 6:  24, 30, 29, 22, 23

P.CAPS[P.S_JOURNEYMAN]		= {60, 26, 29, 28, 23, 23, 30} --__8

P.CAPS[P.SWORDMASTER_F]		= {60, 22, 29, 30, 22, 25, 30} --678
P.CAPS[P.SWORDMASTER_M]		= {60, 24, 29, 30, 22, 23, 30} --678
P.CAPS[P.ASSASSIN_F]		= {60, 20, 30, 30, 20, 20, 30} --_78
P.CAPS[P.ASSASSIN_M]		= {60, 20, 30, 30, 20, 20, 30} --_78
P.CAPS[P.ROGUE]				= {60, 20, 30, 30, 20, 20, 30} --__8
...
P.PROMO_GAINS[P.PALADIN_M] 			= {2, 1, 1, 1, 2, 1, 0} -- 78
									-- 6:  3, 2, 2, 2, 2, 3 
P.PROMO_GAINS[P.GREAT_KNIGHT_F] 	= {3, 1, 1, 2, 2, 2, 0} --__8
P.PROMO_GAINS[P.GREAT_KNIGHT_M] 	= {3, 2, 1, 2, 2, 1, 0} --__8
